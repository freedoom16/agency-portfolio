        ...
        <section className="mb-32 text-gray-800 text-center">
            ...
            <div className="carousel-inner relative w-full overflow-hidden">
                ...
                <img className="rounded-full shadow-lg mb-6 mx-auto"
                    src="https://mdbootstrap.com/img/Photos/Avatars/img%20(10).jpg" alt="avatar" styles="width: 150px" />
                ...
                <img className="rounded-full shadow-lg mb-6 mx-auto"
                    src="https://mdbootstrap.com/img/Photos/Avatars/img%20(32).jpg" alt="avatar" styles="width: 150px" />
                <div className="flex flex-wrap justify-center">
                    <div className="grow-0 shrink-0 basis-auto w-full lg:w-8/12 px-3">
                ...
                <div className="carousel-item relative float-left w-full">
                <img className="rounded-full shadow-lg mb-6 mx-auto"
                    src="https://mdbootstrap.com/img/Photos/Avatars/img%20(1).jpg" alt="avatar" styles="width: 150px" />
                <div className="flex flex-wrap justify-center">
                    <div className="grow-0 shrink-0 basis-auto w-full lg:w-8/12 px-3">
